...
public enum CountryCode {
    ...
    BO("Bolivia", "BOL", 68, CountryCode.Assignment.OFFICIALLY_ASSIGNED),
    ...
    CD("Congo DRC", "COD", 180, CountryCode.Assignment.OFFICIALLY_ASSIGNED),
    ...
    EZ("Eurozone", (String) null, -1, CountryCode.Assignment.EXCEPTIONALLY_RESERVED),
    ...
    CIV("Ivory Coast", "CIV", 10001, CountryCode.Assignment.USER_ASSIGNED),
    ...
    MK("North Macedonia, Republic of", "MKD", 807, CountryCode.Assignment.OFFICIALLY_ASSIGNED),
    ...
    RU("Russia", "RUS", 643, CountryCode.Assignment.OFFICIALLY_ASSIGNED),
    ...
    SOM("Somaliland", "SOM", 10000, CountryCode.Assignment.USER_ASSIGNED),
    ...
    SZ("Eswatini", "SWZ", 748, CountryCode.Assignment.OFFICIALLY_ASSIGNED),
    ...
    VG("British Virgin Islands", "VGB", 92, CountryCode.Assignment.OFFICIALLY_ASSIGNED),
    ...
    XK("Kosovo, Republic of", "XKX", -1, CountryCode.Assignment.USER_ASSIGNED),
    ...
    public static CountryCode getCountryByName(String name) {
        return (CountryCode) findByName(name).stream().findFirst().orElseThrow(() -> {
            return new IllegalArgumentException(String.format("There's no such country '%s'", name));
        });
    }
