...
public class Step {
    ...
    public static List<Step> getStepForPhoneNumberChange() {
        return Arrays.asList(
            getActivationStep(OnBoardingStep.ON_BOARDING_COMPLETE),
            getPhoneNumberVerificationStep(OnBoardingStep.PHONE_NUMBER_VERIFICATION),
            getDocumentVerificationStep(OnBoardingStep.ON_BOARDING_COMPLETE)
        );
    }
