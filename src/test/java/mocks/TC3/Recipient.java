...
import mocks.TC3.recipients.RecipientBank;
...
public class Recipient {
    ...
    public static Recipient getIndiaRecipient() {
        return Recipient.builder()
            ...
            .middleName("All")
            .email("a@a.pl")
            .phoneNumber("123543745")
            .address(RecipientAddress.getIndiaRecipientAddress())
            .build();
    }
}
